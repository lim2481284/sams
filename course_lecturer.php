								...
								<div class="card">
									<div class="content all-icons">
										...
										<div class='courseMenu'>
											<button class='courseMenuList assignmentBtn menuActive' href=''> Assignment </button>
											|
											<button class='courseMenuList materialBtn' href=''> Material </button>
											|
											<button class='courseMenuList studentBtn' > Student list </button>
										</div>
